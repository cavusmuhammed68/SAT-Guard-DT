...
<div class='ap' style='animation-delay:.8s;background:#e0f2fe;border:1px solid #7dd3fc;border-radius:9px;padding:9px 10px;text-align:center;'><div style='font-size:20px;'>📏</div><div style='font-size:14px;font-weight:600;color:#0369a1;margin:3px 0;'>RIIO-ED2</div><div style='font-size:10px;color:#0284c7;'>Calibration source</div></div>
         ...
         "viz":"<svg viewBox='0 0 220 220' style='width:100%;max-width:380px;'><polyline fill='none' stroke='#e2e8f0' stroke-width='1' points='42,185 200,185'/><polyline fill='none' stroke='#e2e8f0' stroke-width='1' points='42,185 42,22'/><polyline fill='none' stroke='#8b5cf6' stroke-width='2.5' stroke-linecap='round' points='42,183 58,180 74,175 90,167 106,153 122,134 138,114 154,97 170,84 186,76 200,72' style='stroke-dasharray:400;stroke-dashoffset:400;animation:drawL .8s .2s ease forwards;'/><circle cx='136' cy='116' r='6' fill='#8b5cf6' class='ap' style='animation-delay:1.1s;'/><text x='144' y='112' font-size='10' fill='#7c3aed' font-family='sans-serif' font-weight='600' class='af' style='animation-delay:1.1s;'>50% @ risk=58</text><circle cx='54' cy='181' r='5' fill='#10b981' class='ap' style='animation-delay:1.3s;'/><text x='62' y='177' font-size='10' fill='#059669' font-family='sans-serif' font-weight='600' class='af' style='animation-delay:1.3s;'>~1% calm 🌤️</text><text x='42' y='198' font-size='10' fill='#94a3b8' font-family='sans-serif' text-anchor='middle'>0</text><text x='200' y='198' font-size='10' fill='#94a3b8' font-family='sans-serif' text-anchor='middle'>100</text><text x='121' y='212' text-anchor='middle' font-size='10' fill='#64748b' font-family='sans-serif'>Risk score →</text><text x='30' y='189' font-size='11' fill='#94a3b8' font-family='sans-serif' text-anchor='middle'>0%</text><text x='30' y='103' font-size='11' fill='#94a3b8' font-family='sans-serif' text-anchor='middle'>50%</text><text x='30' y='26' font-size='11' fill='#94a3b8' font-family='sans-serif' text-anchor='middle'>100%</text><line x1='42' y1='103' x2='200' y2='103' stroke='#f1f5f9' stroke-width='1' stroke-dasharray='4 3'/><text x='10' y='110' font-size='11' fill='#8b5cf6' font-family='sans-serif' transform='rotate(-90 10 110)'>Failure prob.</text></svg>"},
...
<div class='ar' style='animation-delay:.6s;display:flex;align-items:center;justify-content:space-between;padding:9px 12px;background:#0f172a;border-radius:8px;margin-top:3px;'><span style='font-size:12px;color:#e2e8f0;font-weight:600;'>📊 × scenario multiplier</span><span style='font-size:11px;color:#94a3b8;'>1.0× → 4.2×</span></div>
         ...
         "viz":"<svg viewBox='0 0 180 200' style='width:100%;max-width:380px;'><text x='90' y='16' text-anchor='middle' font-size='10' font-weight='600' fill='#64748b' font-family='sans-serif'>Live total: £183m</text><rect x='10' y='28' width='160' height='24' rx='5' fill='#3b82f6' class='af' style='animation-delay:.05s;'/><text x='90' y='44' text-anchor='middle' font-size='10' fill='#fff' font-family='sans-serif' class='af' style='animation-delay:.07s;'>⚡ VoLL ~£119m (65%)</text><rect x='10' y='56' width='50' height='20' rx='5' fill='#10b981' class='af' style='animation-delay:.15s;'/><text x='35' y='70' text-anchor='middle' font-size='10' fill='#fff' font-family='sans-serif' class='af' style='animation-delay:.17s;'>🏠 £15m</text><rect x='64' y='56' width='96' height='20' rx='5' fill='#f59e0b' class='af' style='animation-delay:.25s;'/><text x='112' y='70' text-anchor='middle' font-size='10' fill='#fff' font-family='sans-serif' class='af' style='animation-delay:.27s;'>🏢 Business £27m</text><rect x='10' y='80' width='30' height='18' rx='5' fill='#8b5cf6' class='af' style='animation-delay:.35s;'/><text x='25' y='93' text-anchor='middle' font-size='8' fill='#fff' font-family='sans-serif'>🔧</text><rect x='44' y='80' width='40' height='18' rx='5' fill='#ec4899' class='af' style='animation-delay:.45s;'/><text x='64' y='93' text-anchor='middle' font-size='8' fill='#fff' font-family='sans-serif'>🏥 £13m</text><line x1='90' y1='104' x2='90' y2='122' stroke='#64748b' stroke-width='1.5' class='al' style='animation-delay:.65s;stroke-dasharray:25;stroke-dashoffset:25;'/><rect x='10' y='124' width='160' height='26' rx='7' fill='#0f172a' class='ap' style='animation-delay:.75s;'/><text x='90' y='141' text-anchor='middle' font-size='10' font-weight='700' fill='#fff' font-family='sans-serif' class='af' style='animation-delay:.77s;'>× scenario multiplier</text><rect x='10' y='158' width='42' height='22' rx='5' fill='#22c55e' class='ap' style='animation-delay:.9s;'/><text x='31' y='173' text-anchor='middle' font-size='10' fill='#fff' font-family='sans-serif'>1.0× ☀️</text><rect x='57' y='158' width='42' height='22' rx='5' fill='#f97316' class='ap' style='animation-delay:1s;'/><text x='78' y='173' text-anchor='middle' font-size='10' fill='#fff' font-family='sans-serif'>2.4× 🌊</text><rect x='104' y='158' width='66' height='22' rx='5' fill='#dc2626' class='ap' style='animation-delay:1.1s;'/><text x='137' y='173' text-anchor='middle' font-size='10' fill='#fff' font-family='sans-serif'>4.2× 🌑 = £771m</text></svg>"},
    ]
},
