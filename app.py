...
<div class='ar' style='animation-delay:.68s;display:flex;align-items:center;gap:8px;padding:7px 12px;background:#dcfce7;border-radius:8px;'><span style='font-size:16px;'>🚗</span><span style='font-size:12px;color:#166534;'>EV/V2G coverage present</span></div>
         ...
         "viz":"<svg viewBox='0 0 180 160' style='width:100%;max-width:180px;'><circle cx='90' cy='70' r='58' fill='#dcfce7' stroke='#86efac' stroke-width='2' class='ap' style='animation-delay:.1s;'/><text x='90' y='60' text-anchor='middle' font-size='36' font-family='sans-serif' class='af' style='animation-delay:.3s;'>✅</text><text x='90' y='88' text-anchor='middle' font-size='14' font-weight='700' fill='#15803d' font-family='sans-serif' class='af' style='animation-delay:.4s;'>10 / 10</text><text x='90' y='104' text-anchor='middle' font-size='13' fill='#166534' font-family='sans-serif' class='af' style='animation-delay:.45s;'>checks pass</text><text x='90' y='148' text-anchor='middle' font-size='13' fill='#94a3b8' font-family='sans-serif'>Non-black-box standard ✓</text></svg>"},
    ]
},
...
<div class='ar' style='animation-delay:.55s;display:flex;align-items:center;gap:10px;padding:9px 13px;background:#0c4a6e;border-radius:9px;'><span style='font-size:18px;'>🏙️</span><span style='flex:1;font-size:12px;color:#bae6fd;font-weight:500;'>Layer 6 — city labels (DOM overlay)</span><span style='background:#075985;color:#7dd3fc;font-size:10px;padding:2px 8px;border-radius:8px;'>z=6</span></div>
         ...
         "viz":"<svg viewBox='0 0 180 170' style='width:100%;max-width:180px;'><rect x='10' y='10' width='160' height='140' rx='8' fill='#0f172a'/><rect x='10' y='10' width='160' height='28' rx='8' fill='#1e293b'/><text x='90' y='28' text-anchor='middle' font-size='13' fill='#94a3b8' font-family='sans-serif'>🌌 Backdrop</text><rect x='10' y='36' width='160' height='22' fill='#1e3a5f'/><text x='90' y='51' text-anchor='middle' font-size='13' fill='#7dd3fc' font-family='sans-serif'>🌀 Pressure isobars</text><rect x='10' y='56' width='160' height='22' fill='#14532d'/><text x='90' y='71' text-anchor='middle' font-size='13' fill='#86efac' font-family='sans-serif'>🌧️ Rain + clouds</text><rect x='10' y='76' width='160' height='22' fill='#4a1d96'/><text x='90' y='91' text-anchor='middle' font-size='13' fill='#d8b4fe' font-family='sans-serif'>🌡️ Fronts</text><rect x='10' y='96' width='160' height='22' fill='#713f12'/><text x='90' y='111' text-anchor='middle' font-size='13' fill='#fde68a' font-family='sans-serif'>💨 155 wind arrows</text><rect x='10' y='116' width='160' height='22' rx='0' fill='#0c4a6e'/><text x='90' y='131' text-anchor='middle' font-size='13' fill='#bae6fd' font-family='sans-serif'>🏙️ City labels</text><text x='90' y='162' text-anchor='middle' font-size='13' fill='#94a3b8' font-family='sans-serif'>60fps · requestAnimationFrame</text></svg>"},
    ]
},
